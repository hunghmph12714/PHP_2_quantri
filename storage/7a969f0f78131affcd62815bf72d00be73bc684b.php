        ...
        <div class="col-6 offset-3">
            <form action="" method="post" id="cate_form">
                <div class="form-group">
                    ...
                    <input type="text" name="name" value="<?php echo e($pro->name); ?>" class="form-control">
                                       <?php if(isset($errors) && isset($errors['name'])): ?>
                        <span class="has-error text-danger"><?php echo e($errors['name']); ?></span>
                    <?php endif; ?>
                </div> <div class="form-group">
                    <label for="">Giá sản phẩm</label>
                    <input type="number" value="<?php echo e($pro->price); ?>" name="price" class="form-control">
                    ...
                    <img width="100px" src="<?php echo e(BASE_URL. $pro->image); ?>" alt="">
                   ...
                   <label for="">Tên danh mục</label>
                    ...
                    <?php $__currentLoopData = $cates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option <?php if($item->id==$pro->cate_id): ?>
                            <?php echo e("selected"); ?>

                            
                        <?php endif; ?> value="<?php echo e($item->id); ?>"><?php echo e($item->cate_name); ?></option>
                ...
                <div class="form-group">
                    ...
                    <textarea name="detail" class="form-control" rows="10"><?php echo e($pro->detail); ?></textarea>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PHP_2\lesson6\app\views/admin/product/edit-product.blade.php ENDPATH**/ ?>