            ...
            <div class="card">
                <table class="table table-stripped">
                    <thead>
                        ...
                        <th> Chi tiét  </th>
                        <th>
                            <a href="<?php echo e(BASE_URL . 'products/add'); ?>" class="btn btn-sm btn-success">Tạo mới</a>
                        </th>
                    </thead>
                    <tbody>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PHP_2\lesson6\app\views/admin/product/index.blade.php ENDPATH**/ ?>